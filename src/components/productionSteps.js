      ...
      <div className="container">
        ...
        <div className=" w-full relative my-8 md:mt-24  flex flex-col md:flex-row justify-between md:justify-around">
          <div className="absolute h-full md:w-full md:h-2 shadow-2xltramsform -translate-x-1/2 w-2 bg-black rounded-2xl md:rounded-3xl flex flex-col md:flex-row items-center justify-around">
            ...
            <div className="py-2 md:py-4 bg-white rounded-full relative line-top">
          ...
          {boxes.map((box, key) => {
            return (
              <div
                className={`rounded-xl  md:mt-12 md:mx-3 relative xl:mt-16 md:rounded-2xl gsap-anim-item-steps shadow-lg p-4 md:p-6  w-4/5 my-4 md:my-0 md:w-1/5 ${
                  key === 1 || key === 3
                  ...
                  key === 1 || key === 3
                    ? `md:mt-20 xl:mt-24 md:relative md:top-20 `
                    : ``
                } `}
                key={key}
              >
                <h3 className={`text-center md:leading-tight`}>
                  {box.node.blocks[0].attributes.content}
                </h3>
                <p className={`py-2 md:py-3 md:hidden `}>
