...
const ContactIntro = () => {
  ...
  return (
    <section className="container gsap-container-contact-intro mt-24 md:mt-32 py-8 md:py-24 md:flex md:justify-between md:items-center">
      <div className="md:w-1/2 xl:w-1/3">
        ...
        <a
          className="font-semibold gsap-anim-item-contact-intro"
          href={`tel:${contactIntroContent[2].attributes.content}`}
        >
          <p className="pt-2 gsap-anim-item-contact-intro">
            {contactIntroContent[2].attributes.content}
          </p>
        </a>
        <a
          className="font-semibold underline gsap-anim-item-contact-intro"
          href={`mailTo:${contactIntroContent[3].attributes.content}`}
        >
          <p className="pb-2 gsap-anim-item-contact-intro">
            {contactIntroContent[3].attributes.content}
          </p>
        </a>
        <div className="flex pt-2 md:pt-4 xl:pt-8">
          <a
            className="gsap-anim-item-contact-intro font-semibold"
